...
#Import Source
JP_BD = FileInfo(r"D:/BDMV/[BDMV][210728][slime 300][Vol.2 Fin]/BD/BDMV/STREAM/00003.m2ts",
...
#Tạo Chapter
CHAPTERS = MplsReader(r"D:/BDMV/[BDMV][210728][slime 300][Vol.2 Fin]/BD", lang=JAPANESE) \
    .get_playlist()[1].mpls_chapters[int(EP_NUM)-7].to_chapters()
CHAP_NAMES: Sequence[Optional[str]] = ['Intro', 'Part A', 'Part B', 'Ending']
...
class Filtering:
    def main(self) -> vs.VideoNode:
        ...
        credit = flt.restore_credits(
            out, src, None, (EDSTART, EDEND), show_mask=False,
