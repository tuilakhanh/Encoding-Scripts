...
#Import Source
JP_BD = FileInfo(r"D:/BDMV/[BDMV][210630][slime 300][Vol.1]/BD/BDMV/STREAM/00000.m2ts",
                (24, 34072), idx=lambda x: lvf.src(x, force_lsmas=True, cachedir=''),
...
CHAP_NAMES: Sequence[Optional[str]] = ['Intro', 'Part A', 'Part B', 'Opening']
...
if __name__ == '__main__':
    ...
    JP_NED.clip_cut.set_output(5)
    JP_NOP.clip_cut.set_output(6)
    FILTERED = Filtering().main()
